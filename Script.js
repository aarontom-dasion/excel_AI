 ...
 */
 ...
 var preface = "I am an AI trained to answer questions about companies and their attributes. If I don't have an answer, I'll respond with 'Unknown' You are a highly intelligent assistant. Your role is to provide information as concisely as possible, as requested.\n\n";
 ...
 function gpt4Fill() {
   ...
   for (var col = 2; col <= numCols; col++) {  // Skip first column (entity names)
     ...
     for (var row = 2; row <= numRows; row++) {  // Skip header row
       ...
       var prompt = `Q: What is the ${propertyName} of ${entityName}? Answer to the best of your knowledge. If your information is up to a certain date, and the question requires real-time data, answer in the format 'year : [information]'. Otherwise simply just be concise in your answer`;
